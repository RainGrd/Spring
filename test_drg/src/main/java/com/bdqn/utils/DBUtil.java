...
public class DBUtil {
    ...
    public static <T> T queryOne(Class<T> clazz, String sql, Object... args) {
        ...
        try {
            String[] dataColumns = splicingColumnName(args);
            if (clazz.getName().equals("int") || clazz.getName().equals("long") || clazz.getName().equals("java.lang" +
                    ".Integer") || clazz.getName().equals("java.lang.Long")) {
                rs.next();
